    ...
    <div style={{ minHeight: '100vh', background: '#f5fafb', fontFamily: 'Geist, sans-serif' }}>
      <nav style={{ background: 'white', borderBottom: '1px solid #e4e9ea', padding: '0 32px', height: 64, display: 'flex', alignItems: 'center', justifyContent: 'space-between', maxWidth: 1280, margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', gap: 12 }}>
          <Link to="/login" style={{ padding: '8px 20px', borderRadius: 10, border: '1.5px solid #0ea5a4', color: '#0ea5a4', fontWeight: 600, textDecoration: 'none', fontSize: 14 }}>Sign In</Link>
          <Link to="/register" className="btn-primary" style={{ padding: '8px 20px', borderRadius: 10, textDecoration: 'none', fontSize: 14 }}>Get Started</Link>
        </div>
      </nav>
      ...
      <section ref={heroRef} style={{ maxWidth: 1280, margin: '0 auto', padding: '80px 32px 60px', textAlign: 'center' }}>
        ...
        <div className="hero-anim" style={{ display: 'flex', gap: 16, justifyContent: 'center' }}>
          <Link to="/register" className="btn-primary" style={{ display: 'flex', alignItems: 'center', gap: 8, textDecoration: 'none', fontSize: 16, padding: '14px 32px' }}>
            Start for free <ArrowRight size={18} />
          </Link>
          <Link to="/login" className="btn-secondary" style={{ display: 'flex', alignItems: 'center', gap: 8, textDecoration: 'none', fontSize: 16, padding: '14px 32px' }}>
            Sign in
          </Link>
        </div>
      </section>
      ...
      <section ref={ctaRef} style={{ background: '#131f3d', padding: '60px 32px', textAlign: 'center' }}>
        ...
        <Link to="/register" className="btn-primary" style={{ textDecoration: 'none', fontSize: 16, padding: '14px 40px', display: 'inline-block' }}>
          Create free account
        </Link>
      </section>
